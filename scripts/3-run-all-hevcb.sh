...
python "HNeRV/train_nerv_all.py"  --outf "checkpoint"  --data_path "data/hevc_b/BQTerrace_1920x1080_60" --vid bqt \
...
python "HNeRV/train_nerv_all.py"  --outf "checkpoint"  --data_path "data/hevc_b/BasketballDrive_1920x1080_50" --vid basket \
    --conv_type convnext pshuffel --act gelu --norm none  --crop_list 1080_1920  \
    --resize_list -1 --loss Fusion6  --enc_strds 5 3 2 2 2 --enc_dim 64_16 \
    --dec_strds 5 3 2 2 2 --ks 0_1_5 --reduce 1.2 --dump_images \
    --modelsize 3 -e 300 --eval_freq 150 --lower_width 12 -b 2 --lr 0.001
...
python "HNeRV/train_nerv_all.py"  --outf "checkpoint"  --data_path "data/hevc_b/Cactus_1920x1080_50" --vid cactus \
    --conv_type convnext pshuffel --act gelu --norm none  --crop_list 1080_1920  \
    --resize_list -1 --loss Fusion6  --enc_strds 5 3 2 2 2 --enc_dim 64_16 \
    --dec_strds 5 3 2 2 2 --ks 0_1_5 --reduce 1.2 --dump_images \
    --modelsize 3 -e 300 --eval_freq 150 --lower_width 12 -b 2 --lr 0.001
...
python "HNeRV/train_nerv_all.py"  --outf "checkpoint"  --data_path "data/hevc_b/Kimono_1920x1080_24" --vid kimono \
    --conv_type convnext pshuffel --act gelu --norm none  --crop_list 1080_1920  \
    --resize_list -1 --loss Fusion6  --enc_strds 5 3 2 2 2 --enc_dim 64_16 \
    --dec_strds 5 3 2 2 2 --ks 0_1_5 --reduce 1.2 --dump_images \
    --modelsize 3 -e 300 --eval_freq 150 --lower_width 12 -b 2 --lr 0.001
...
python "HNeRV/train_nerv_all.py"  --outf "checkpoint"  --data_path "data/hevc_b/ParkScene_1920x1080_24" --vid park \
    --conv_type convnext pshuffel --act gelu --norm none  --crop_list 1080_1920  \
    --resize_list -1 --loss Fusion6  --enc_strds 5 3 2 2 2 --enc_dim 64_16 \
    --dec_strds 5 3 2 2 2 --ks 0_1_5 --reduce 1.2 --dump_images \
    --modelsize 3 -e 300 --eval_freq 150 --lower_width 12 -b 2 --lr 0.001
